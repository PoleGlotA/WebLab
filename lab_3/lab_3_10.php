...
<body>
	...
	<form name = "ticktactoe" method = "post" action = "lab_3_10.php">
		<?php
			for($i = 0; $i <=8; $i++)
			{
			...
			{
				print('<input type = "button" name = "newgamebtn" value = "Play Again" id = "go" onclick = "window.location.href=\'lab_3_10.php\'">');
			}
